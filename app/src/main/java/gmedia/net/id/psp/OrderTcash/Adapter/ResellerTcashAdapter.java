package gmedia.net.id.psp.OrderTcash.Adapter;
...
public class ResellerTcashAdapter extends ArrayAdapter{

    private Activity context;
    private List<CustomItem> items;
    private ItemValidation iv = new ItemValidation();

    public ResellerTcashAdapter(Activity context, List<CustomItem> items) {
        super(context, R.layout.cv_reseller_tcash, items);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.cv_reseller_tcash, null);
