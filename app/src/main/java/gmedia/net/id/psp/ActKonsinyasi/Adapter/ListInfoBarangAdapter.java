...
public class ListInfoBarangAdapter extends ArrayAdapter {

    private Activity context;
    private List<CustomItem> items;
    private ItemValidation iv = new ItemValidation();

    public ListInfoBarangAdapter(Activity context, List<CustomItem> items) {
        super(context, R.layout.item_info_barang, items);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.item_info_barang, null);
