...
public class ActivityWebViewDaftarInput extends AppCompatActivity {
    ...
    private static final String TAG = ActivityWebViewDaftarInput.class.getSimpleName();
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
                ...
                if(file_permission() && Build.VERSION.SDK_INT >= 21) {
                    ...
                    if (includePhoto) {
                        ...
                        if (takePictureIntent.resolveActivity(ActivityWebViewDaftarInput.this.getPackageManager()) != null) {
                            File photoFile = null;
                            try {
    ...
    public boolean file_permission(){
        if(Build.VERSION.SDK_INT >=23 && (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED || ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)) {
            ActivityCompat.requestPermissions(ActivityWebViewDaftarInput.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA}, 1);
            return false;
        }else{
            return true;
        }
   ...
   /* private File create_video() throws IOException {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ActivityWebViewDaftarInput.this, MainNavigationActivity.class);
