package gmedia.net.id.psp.PelunasanPenjualan.Adapter;
...
public class ListPelunasanPenjualanAdapter extends ArrayAdapter{

    private Activity context;
    private List<CustomItem> items;
    private ItemValidation iv = new ItemValidation();

    public ListPelunasanPenjualanAdapter(Activity context, List<CustomItem> items) {
        super(context, R.layout.cv_pelunasan_penjualan, items);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.cv_pelunasan_penjualan, null);
