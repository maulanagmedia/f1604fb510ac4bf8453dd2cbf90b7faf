package gmedia.net.id.psp.PenjualanPerdana.Adapter;
...
public class ListPerdanaAdapter extends ArrayAdapter{
    ...
    public ListPerdanaAdapter(Activity context, List<CustomItem> items) {
        super(context, R.layout.cv_list_penjualan_perdana, items);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.cv_list_penjualan_perdana, null);
