...
//	private static final String baseURL = "https://192.168.20.33/psp-sales/";
	...
	public static final String getReseller = baseURL + "api/mkios/get_resellerv2/";
	...
	public static final String saveMKIOSV2 = baseURL + "api/mkios/save_v3/";
	public static final String savePerdana = baseURL + "api/perdana/savev2/";
	public static final String getMkios = baseURL + "api/mkios/get_mkios/";

	public static final String getCustomerPerdana = baseURL + "api/perdana/get_customerv2/";
	...
	public static final String getUserOmset = baseURL + "api/profile/get_user_omset_baruv2/";
	...
	public static final String getCustomerKunjungan = baseURL + "api/customer/get_customer_kunjunganv2/";
	...
	public static final String saveCheckin = baseURL + "api/checkin/savev2/";
	public static final String getKunjungan = baseURL + "api/checkin/get_kunjunganv2/";
	...
	public static final String savePengajuanDeposite = baseURL + "api/deposit/apv_pengajuan_depositv2/";
	public static final String savePengajuanDepositePerdana = baseURL + "api/Deposit/approval_perdanav2/";
	...
	public static final String getTcashReseller = baseURL + "api/tcash/get_resellerv2/";
	...
	public static final String saveTcash = baseURL + "api/tcash/savev2/";
	public static final String saveNGRS = baseURL + "api/tcash/save_ngrsv2/";
	public static final String saveTcashDev = baseURL + "api/tcash/save_devv2/";
	...
	public static final String saveMarketSurvey = baseURL + "api/event/save_market_surveyv2/";
	...
	public static final String viewBarangKonsinyasiCust = baseURL + "api/Konsinyasi/view_baran_percustomer";
	...
	public static final String simpanRekonsinyasi = baseURL + "api/Konsinyasi/simpan_rekonsinyasi_v2";
