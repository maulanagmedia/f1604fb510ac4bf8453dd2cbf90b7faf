package gmedia.net.id.psp.SemuaPenjualan.Adapter;
...
public class ListSemuaPenjalanAdapter extends ArrayAdapter{

    private Activity context;
    private List<CustomItem> items;
    private ItemValidation iv = new ItemValidation();

    public ListSemuaPenjalanAdapter(Activity context, List<CustomItem> items) {
        super(context, R.layout.cv_list_semua_penjualan, items);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.cv_list_semua_penjualan, null);
