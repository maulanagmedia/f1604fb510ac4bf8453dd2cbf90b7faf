...
public class ListStokAdapter extends ArrayAdapter{

    private Activity context;
    private List<CustomItem> items;
    private ItemValidation iv = new ItemValidation();

    public ListStokAdapter(Activity context, List<CustomItem> items) {
        super(context, R.layout.cv_list_stok, items);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.cv_list_stok, null);
