...
public class PiutangPerOutletAdapter extends ArrayAdapter {
    ...
    public PiutangPerOutletAdapter(Context context, List<CustomItem> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            if(tipeViewList == 0){
                ...
                convertView = inflater.inflate(R.layout.adapter_piutang_isi, null);
                holder.tvItem1 = (TextView) convertView.findViewById(R.id.tv_item1);
        ...
        if(tipeViewList == 0){
            ...
            holder.tvItem1.setText(item.getItem5());
